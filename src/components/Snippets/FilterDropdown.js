...
import {priceOfCoin} from "../formula";
...
const FilterDropdown = ({setk}) => {
    ...
    console.log("val",val)
        ...
        if(!isNaN(val)){
            ...
            localStorage.setItem("tokenid1",val);
            setassetsn(0);
            ...
            console.log("string")
            let assetInfo = await indexerClient.searchForAssets().name(val).limit(10).do();
            //console.dir(assetInfo)
            sets(true)
    ...
    function handleClick(e) {   
         e.preventDefault();
         localStorage.setItem("tokenid1",id);
         handleClose();
